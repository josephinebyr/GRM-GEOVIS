...
function update_color_legend_focus() {
	...
	var border_day_ini;
	if(start_date_focus.getDate()<10){border_day_ini = "0" + start_date_focus.getDate()}else{border_day_ini = "" + start_date_focus.getDate() + ""}
	var border_month_ini;
	if((start_date_focus.getMonth() + 1)<10){border_month_ini = "0" + (start_date_focus.getMonth() + 1)}else{border_month_ini = "" + (start_date_focus.getMonth() + 1) + ""}
	var border_year_ini = start_date_focus.getFullYear();
	start_date_focus_slider = "" + border_year_ini + "-" + border_month_ini + "-" + border_day_ini;

	var border_day_ini;
	if(end_date_focus.getDate()<10){border_day_ini = "0" + end_date_focus.getDate()}else{border_day_ini = "" + end_date_focus.getDate() + ""}
	var border_month_ini;
	if((end_date_focus.getMonth() + 1)<10){border_month_ini = "0" + (end_date_focus.getMonth() + 1)}else{border_month_ini = "" + (end_date_focus.getMonth() + 1) + ""}
	...
	if (focus_on) {
		...
		for (i=0; i<list_classes_ini.length; i++){
			...
			if (list_classes_ini[i].start<percentage_value_start && list_classes_ini[i].end > percentage_value_end){
				...
				list_classes.push(rect_classe1,rect_focus,rect_classe2);
				
			} 
			//Focus starts in this class
			else if (list_classes_ini[i].start<=percentage_value_start && list_classes_ini[i].end>=percentage_value_start){
				rect_classe = {
					id : 20,
					start : list_classes_ini[i].start,
					end : percentage_value_start,
				...
				list_classes.push(rect_classe, rect_focus);
	
			}
			//Focus ends in this class 
			else if (list_classes_ini[i].start<=percentage_value_end && list_classes_ini[i].end>=percentage_value_end) {
				rect_focus = {
					id : 300,
					start : list_classes_ini[i].start,
					end : percentage_value_end,
				...
				list_classes.push(rect_focus, rect_classe);
	
			} 
			
			else {
				//Focus covering the entire class
				if (list_classes_ini[i].start > percentage_value_start && list_classes_ini[i].end < percentage_value_end) {
					rect_focus = {
						id : 400,
						start : list_classes_ini[i].start,
					...
					list_classes.push(rect_focus)
				} else {
					list_classes.push(list_classes_ini[i])
				}
			}
		}
